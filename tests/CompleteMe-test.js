...
describe('COMPLETE ME', () => {
  ...
  describe('suggest', () => {
    ...
    it('should put selected word at front of suggested array', (done) => {
      ...
      expect(completion.suggest('piz')).to.deep.eq(["pizzeria", "pize", "pizza", "pizzicato", "pizzle"]);
      completion.select('pizzeria');
      completion.select('pizza');
      expect(completion.suggest('piz')).to.deep.eq(["pizzeria", "pizza", "pize", "pizzicato", "pizzle"]);
